...
Algoritam \textit{JellyFish} je testiran nad realnim podacima, odnosno nad k-merima ekstrahovanim iz očitavanja bakterije \textit{Staphylococcus aureus} koja su napravljena sekvencerom \textit{Illumina MiSeq}. Pokazao je izuzetnu brzinu i tačnost i prilikom sekvencijalne i prilikom paralelne obrade. Implementacijom konkurentnosti dobijeno je skoro dva puta veće ubrzanje izvršavanja u odnosu na sekvencijalno izvršavanja. Na na taj način je ubrzana i olakšana obrada celokupnog skupa podataka i pokazano je da je Elixir dobar izbor.
