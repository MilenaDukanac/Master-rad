...
Nakon izvršavanja algoritma, rezultat je smešten u tekstualnom fajlu \textit{allEulerianCyceles.txt}. Izlazni fajl sadrži listu kontiga, koje predstavljaju cikluse u De Brujinovom grafu i prikazane su na listingu \ref{lst:eulerRezultati}.
