...
Pomenuti koraci su prikazani na slici \ref{fig:1}.

\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.7\textwidth]{prva.png}
  \caption{\textit{Shotgun} sekvencioniranje celokupnog genoma}
\label{fig:1}
\source{\cite{WingKinSung} str. 122, slika 5.1}
\end{figure}
...
\begin{figure}[!ht]
  ...
  \label{fig:2}
  \source{\cite{WingKinSung} str. 122, slika 5.2}
\end{figure}

 Za sekvencioniranje jednostranih očitavanja, dobija se očitavanje sa $5'$ kraja gornjeg lanca, tj. $ACTCAGCACCTTACGGCGTGCATCA$. Za sekvencioniranje uparenih očitavanja, dobijaju se $5'$ očitavanja i gornjeg i donjeg lanca, pri čemu je drugo očitavanje inverzni komplement prvog, tj:
...
\begin{figure}[!ht]
  ...
  \caption{Sekvencioniranje partner-uparenih očitavanja}
\source{\cite{WingKinSung} str. 123, slika 5.3}
\label{fig:3}
\end{figure}
...
Iako protokol za sekvencioniranje partner-uparenih očitavanja može izdvojiti uparena očitavanja velike dužine očitavanja, on zahteva veći broj ulaznih kopija genoma za pripremu sekvencerskih biblioteka i sklon je greškama.
\begin{comment}
...
\begin{figure}[!ht]
  ...
  \caption{\textit{De novo} sekvencioniranje genoma za kratka očitavanja}
  \label{fig:4}
  \source{\cite{WingKinSung} str. 124, slika 5.4}
\end{figure}
