...
\begin{figure}[!ht]
\begin{tcolorbox}
\textbf{Algoritam All\_Eulerian\_cycles}(\textit{graph})
...
\end{tcolorbox}
\caption{Algoritam \textit{All\_Eulerian\_cycles} \cite{bioinformaticsAlg}}
